...
def multiply_numbers(sequence_of_lists):
    ...
    for k in range(len(sequence_of_lists)):
        for b in range(len(sequence_of_lists[k])):
            sequence_of_lists[k][b] = sequence_of_lists[k][b]*(k+1)
...
def print_characters(sequence_of_strings):
    ...
    for k in range(len(sequence_of_strings)):
        for b in range(len(sequence_of_strings[k])):
            print(sequence_of_strings[k][b])
